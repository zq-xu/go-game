...
const gamingStageName stage.StageName = "gaming"

// Implement stage.Stage
type game struct {
...
func (gs *game) StageName() stage.StageName {
	return gamingStageName
}

// NewGamingStage
func NewGameStage() (stage.Stage, error) {
	var err error
	g := &game{}
